...
| [blog-post-writer-petems](skills/blog-post-writer-petems/SKILL.md)                     | Transform brain dumps into blog posts in Peter's casual, self-deprecating British voice |
| [conference-talk-builder-petems](skills/conference-talk-builder-petems/SKILL.md)        | Build conference talk outlines and iA Presenter slides using the Story Circle framework |
