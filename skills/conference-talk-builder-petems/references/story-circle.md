...
*Top half - Order.* Introduce yourself and the current status quo of your project.
...
*Top half - Order.* Identify and explain the problem you're trying to solve.
...
*Crossing to bottom half - Chaos.* Describe the steps taken to address the problem.
...
*Bottom half - Chaos.* Detail the process of digging into the actual problem.
...
*Bottom half - Chaos.* Explain how you found the solution or made progress.
...
*Bottom half - Chaos.* Discuss the actual implementation of the project.
...
*Crossing to top half - Order.* Describe the results and how the solution was integrated.
...
*Top half - Order.* Conclude with lessons learned and how things changed.
